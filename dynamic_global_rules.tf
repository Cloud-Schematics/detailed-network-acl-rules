        ...
        [
          {
            ...
            network_acl = data.ibm_is_network_acl.network_acl[network_acl.shortname].id
            before      = var.apply_new_rules_before_old_rules == true ? local.first_rules[network_acl.shortname] : null
            source      = "0.0.0.0/0"
